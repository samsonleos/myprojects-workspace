...
<body>
    ...
    <div class="well lead">Account Info For User</div>
...
href="<c:url value='/accountinfobyuser' />">Cancel</a>
                    </c:when>
                    <c:otherwise>
                        <input type="submit" value="Display Account Info" class="btn btn-primary btn-sm"/> or <a
